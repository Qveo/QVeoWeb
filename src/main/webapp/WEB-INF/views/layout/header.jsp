...
<ul id="slide-out" class="sidenav">
	<div>
		<a href="${pageContext.request.contextPath}/home"><img class="logo-link-sidenav"
	...
	<li><a href="<c:url value="/admin/peliculas/listar" />">Lista pel&iacuteculas</a></li>
	<li><a href="<c:url value="/admin/paises/listar" />">Lista paises</a></li>
	<li><a href="<c:url value="/admin/genero/list" />">Lista g&eacuteneros</a></li>
