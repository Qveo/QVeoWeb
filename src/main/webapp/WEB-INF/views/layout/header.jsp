	...
	<div>
		...
		<li><a href="${pageContext.request.contextPath}/usuario"><img class="circle icon-user" src="${pageContext.request.contextPath}/resources/img/iconouser.jpg"></a></li>
		</ul>
		...
		<div>
		<a href="#"><img class="circle icon-user icon-user-sidenav" src="${pageContext.request.contextPath}/resources/img/iconouser.jpg"></a></div>
